...
public enum ErrorCode {
    ...
    SEAT_ALREADY_OCCUPIED(HttpStatus.CONFLICT,"이미 예약된 좌석입니다"),
    SEAT_ALREADT_OCCUPIED(HttpStatus.CONFLICT,"다른 사용자가 결제 중인 좌석입니다"),
...
/* 에러 목록
잘못된 요청(400) : INVALID_PASSWORD, INVALID_INPUT_VALUE
찾을 수 없음(404) : USER_NOT_FOUND, SEAT_NOT_FOUND
